...
this.reply(m.chat, `*𝗡𝗢 𝗧𝗜𝗘𝗡𝗘 𝗚𝗔𝗬𝗖𝗢𝗜𝗡𝗦 🏳️‍🌈*`, m)
continue     
}
...
if (m.money)
m.reply(+m.money + ' 𝗚𝗔𝗬𝗖𝗢𝗜𝗡(𝗦) 𝗨𝗦𝗔𝗗𝗢(𝗦) 🏳️‍🌈')  
break
}}} catch (e) {
console.error(e)
} finally {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝗦𝘂𝗽𝗲𝗿 𝗚𝗮𝘆𝗕𝗼𝘁 👻') :
...
"thumbnail": apii.data, 
"title": [wm, '𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 👻', '🌟 centergaybot.gmail.com'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: [md, nnt, nnt2, nnt3, yt, ig, tt, tt2, paypal, fb].getRandom()}}}, { quoted: fkontak2 }) 
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 👻', '🌟 centergaybot.gmail.com'].getRandom(), thumbnail: img.getRandom(), sourceUrl: [md, nnt, nnt2, nnt3, yt, ig, tt, tt2, paypal, fb].getRandom() }}}}, tg)
