//ESTOS DISEÑOS PARA MENSAJES SON COMPATIBLES CON GAYBOT, SIN EMBARGO ALGUNOS NO SE VEN EN LA VERSIÓN DE WHATSAPP WEB
//PERO EN EL CELULAR SI SE NOTAN TODOS, PUEDES USAR EL QUE QUIERAS 😼
...
let sgh = md
let sgc = nnn
let gay = 'https://i.imgur.com/EXTbyyn.jpg'
//let logo = 'https://i.pinimg.com/564x/f7/d2/e4/f7d2e48fd59a8c01cd396bfc70b0a2d1.jpg'
let pp = await conn.profilePictureUrl(who).catch(_ => gay)
...
//global.enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝗦𝘂𝗽𝗲𝗿 𝗚𝗮𝘆𝗕𝗼𝘁 👻', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
