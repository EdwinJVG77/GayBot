...
_Te falta ${max - user.exp} XP para subir de nivel._
`.trim()
    }
...
_¡Cuanto más interactúes con GayBot, mayor será tu nivel!_
_¡Actualiza tu rango con el comando ${usedPrefix}rol!_
`.trim()
        try {
