...
**/
    ...
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://github.com/EdwinJVG77/GayBot'}}}}}, {});
    }
  }
};
handler.command = /^(hidetag|comunicate|notificar|notify)$/i;
handler.group = true;
handler.admin = true;
