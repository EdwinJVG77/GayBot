...
let gay = Math.floor(Math.random() * 3000)
global.db.data.users[m.sender].exp += gay * 1  
let time = global.db.data.users[m.sender].lastwork + 600000
if (new Date - global.db.data.users[m.sender].lastwork < 600000) throw `*𝗬𝗔 𝗧𝗥𝗔𝗕𝗔𝗝𝗔𝗦𝗧𝗘, 𝗘𝗦𝗣𝗘𝗥𝗔 ${msToTime(time - new Date())} 𝗣𝗔𝗥𝗔 𝗩𝗢𝗟𝗩𝗘𝗥 𝗔 𝗧𝗥𝗔𝗕𝗔𝗝𝗔𝗥*`

await conn.reply(m.chat, `*${pickRandom(global.work)}* *${gay} XP*`, fkontak, pp, m)
