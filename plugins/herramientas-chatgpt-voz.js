...
const sistema1 = `Actuarás como un Bot de WhatsApp el cual fue creado por Edwin, tú serás GayBot`;
...
handler.command = /^(openaivoz|chatgptvoz|iavoz|gptvoz|ai_voz|ai_voce)$/i;
