...
let handler = async (m, { args, usedPrefix, command }) => {
    ...
    if (isNaN(args[0])) throw `${lenguajeGB['smsAvisoMG']()}*𝗘𝗟𝗜𝗝𝗔 𝗨𝗡 𝗡𝗨𝗠𝗘𝗥𝗢 𝗗𝗘𝗟 1 𝗔𝗟 99*\n\n*𝗘𝗝𝗘𝗠𝗣𝗟𝗢: ${usedPrefix + command} 1*`
    if (args[0]) {
        if (args[0] < 1 || args[0] > 99) throw `${lenguajeGB['smsAvisoFG']()}*¡𝗠𝗜𝗡𝗜𝗠𝗢 1 𝗬 𝗠𝗔𝗫𝗜𝗠𝗢 99!*`
