...
if (new Date - user.prue < 90000) return await conn.reply(m.chat, `*𝗡𝗢 𝗦𝗣𝗔𝗠 𝗣𝗨𝗧𝗢 🤬*`, fkontak, m)
let start = `*😱 ¡¡𝗘𝗠𝗣𝗘𝗭𝗔𝗡𝗗𝗢 𝗗𝗢𝗫𝗫𝗘𝗢!! 😱*`
...
let speed = `${neww - old}`
let doxeo = `*✅ 𝗣𝗘𝗥𝗦𝗢𝗡𝗔 𝗗𝗢𝗫𝗫𝗘𝗔𝗗𝗔 𝗖𝗢𝗡 𝗘𝗫𝗜𝗧𝗢 ✅*\n\n*𝗧𝗜𝗘𝗠𝗣𝗢: ${speed} 𝗦𝗘𝗚𝗨𝗡𝗗𝗢𝗦*
