...
let handler = async (m, {conn, args: [effect], text: txt, usedPrefix, command, name}) => {
  if (!effect)
    throw (
      "*[❗𝗜𝗡𝗙𝗢❗] ¿𝗖𝗢𝗠𝗢 𝗨𝗦𝗔𝗥 𝗘𝗦𝗧𝗘 𝗖𝗢𝗠𝗔𝗡𝗗𝗢?*\n— *#logo (efecto) (texto)*\n*𝗘𝗝𝗘𝗠𝗣𝗟𝗢:*\n— *#logo 3d-deep-sea-metal GayBot*\n\n*[❗] 𝗖𝗨𝗔𝗡𝗗𝗢 𝗗𝗜𝗚𝗔 𝗤𝗨𝗘 𝗛𝗔𝗖𝗘 𝗙𝗔𝗟𝗧𝗔 𝗨𝗡 𝗧𝗘𝗫𝗧𝗢, 𝗘𝗟 𝗨𝗦𝗢 𝗦𝗘𝗥𝗜𝗔:*\n— *#logo (efecto) (texto1|texto2)*\n*𝗘𝗝𝗘𝗠𝗣𝗟𝗢:*\n— *#logo Wolf-Logo-Galaxy Logo|Bot*\n\n*𝗟𝗜𝗦𝗧𝗔 𝗗𝗘 𝗘𝗙𝗘𝗖𝗧𝗢𝗦*\n\n📝➯ *#logo* " +
      effects.map((v) => v.title).join("\n📝➯ *#logo* ")
    );
     if (!effects.find((v) => (new RegExp(v.title, 'gi')).test(effect))) throw `*[❗𝗜𝗡𝗙𝗢❗] 𝗘𝗟 𝗘𝗙𝗘𝗖𝗧𝗢 ${effect} 𝗡𝗢 𝗘𝗦𝗧𝗔 𝗘𝗡 𝗠𝗜 𝗟𝗜𝗦𝗧𝗔 𝗗𝗘 𝗘𝗙𝗘𝗖𝗧𝗢𝗦*`;   
   ...
   const res = await maker(effectoSelect?.url, [...text]) 
    if (typeof res == 'number') throw res == -1 ? `*[❗𝗜𝗡𝗙𝗢❗] 𝗘𝗟 𝗘𝗙𝗘𝗖𝗧𝗢 ${effect} 𝗡𝗢 𝗘𝗦𝗧𝗔 𝗘𝗡 𝗠𝗜 𝗟𝗜𝗦𝗧𝗔 𝗗𝗘 𝗘𝗙𝗘𝗖𝗧𝗢𝗦*` : `*[❗𝗜𝗡𝗙𝗢❗] 𝗘𝗟 𝗨𝗦𝗢 𝗖𝗢𝗥𝗥𝗘𝗖𝗧𝗢 𝗗𝗘𝗟 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 𝗘𝗦 ${usedPrefix + command} ${effect} ${new Array(res).fill('texto').map((v, i) => v + (i ? i + 1 : '')).join('|')}*`; 
   await conn.sendMessage(m.chat, {image: {url: res.image}, caption: `*¡𝗧𝗢𝗠𝗔 𝗧𝗨 𝗜𝗠𝗔𝗚𝗘𝗡 𝗣𝗘𝗥𝗦𝗢𝗡𝗔𝗟𝗜𝗭𝗔𝗗𝗔!*\n*𝗘𝗙𝗘𝗖𝗧𝗢: ${effect}*`}, {quoted: m});   
 }; 
 handler.help = ['logos']; 
 handler.tags = ['nulis']; 
