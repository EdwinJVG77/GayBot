...
if (command == 'miestado') { 
if (!text) return conn.sendMessage(m.chat, {text: `*¿𝗖𝗢𝗠𝗢 𝗘𝗦𝗧𝗔 𝗛𝗢𝗬? 🤔 ${user.registered === true ? user.name : name}*\n\n*╭━━━━━━━━━━━━━━━━━━*\n*┃ 𝗦𝗘𝗟𝗘𝗖𝗖𝗜𝗢𝗡𝗘 𝗦𝗨 𝗘𝗦𝗧𝗔𝗗𝗢*\n*┃━━━━━━━━━━━━━━━━━━*\n*┃ 𝗘𝗦𝗧𝗔𝗗𝗢 𝗔𝗖𝗧𝗨𝗔𝗟:* ${typeof user.miestado === 'string' ? user.miestado : '*Estado no asignado*\n*┃ 𝗘𝗝𝗘𝗠𝗣𝗟𝗢: /miestado 😃*'}\n*╰━━━━━━━━━━━━━━━━━━*`}, {quoted: fkontak})
miEstado = text.trim()
user.miestado = miEstado
if (text) return conn.sendMessage(m.chat, {text: eg + `*¡𝗚𝗘𝗡𝗜𝗔𝗟! 𝗦𝗘 𝗛𝗔 𝗔𝗚𝗥𝗔𝗚𝗔𝗗𝗢 𝗨𝗡 𝗘𝗦𝗧𝗔𝗗𝗢*\n*━━━━━━━━━━━━━━━━━━━━━━━━━━━*\n\n` + `*𝗦𝗨 𝗘𝗦𝗧𝗔𝗗𝗢:* ${user.miestado}`}, {quoted: fkontak})
miEstado = 0
}}
handler.command = ['miestado', 'mystatus'] 
