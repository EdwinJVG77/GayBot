...
if wget -q https://github.com/EdwinJVG77/GayBot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/EdwinJVG77/GayBot.git
...
echo -e "\033[01;32m\033[01mIniciando GayBot!!\nStarting GayBot!!\n\033[0m"
npm start
