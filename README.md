...
<p align="center"> 
<a href="https://github.com/EdwinJVG77"><img src="http://readme-typing-svg.herokuapp.com?font=mono&size=17&duration=4000&color=F7B11B&center=falso&vCenter=falso&lines=GayBot++%F0%9F%90%88;Gracias+por+visitar+este+repositorio.+%F0%9F%92%96" height="90px"></a> 
</p>

<p align="center">
<img src="https://tinyurl.com/29q8ovz6" alt="GayBot" width="900"/>
</p>

<p align="center">
<a href="#"><img title="GayBot" src="https://img.shields.io/badge/SI TE AGRADA EL REPOSITORIO APOYAME CON UNA 🌟 ¡GRACIAS! -red?colorA=%255ff0000&colorB=%23017e40&style=for-the-badge"></a> 
<img src="https://i.pinimg.com/originals/d4/3c/90/d43c902873d4db8c85974dfd0798030b.gif" height="28px">
</p>  

<p align="center">
<a href="#"><img title="GayBot" src="https://img.shields.io/badge/LEA TODO EL README-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge"></a> 
<a href="#"><img title="GayBot" src="https://img.shields.io/badge/COMPATIBLE CON LA VERSIÓN MULTI DISPOSITIVOS DE WHATSAPP-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge"></a>
</p>

<p align="center">   
<a href="https://github.com/EdwinJVG77/GayBot/network/members"><img title="Forks" src="https://img.shields.io/github/forks/EdwinJVG77/GayBot?label=Forks&color=blue&style=flat-square"></a>
<a href="https://github.com/EdwinJVG77/GayBot/watchers"><img title="Watchers" src="https://img.shields.io/github/watchers/EdwinJVG77/GayBot?label=Watchers&color=green&style=flat-square"></a>
<a href="https://github.com/EdwinJVG77/GayBot/stargazers"><img title="Stars" src="https://img.shields.io/github/stars/EdwinJVG77/GayBot?label=Stars&color=yellow&style=flat-square"></a>
</p>

<div align="center">
<a href="mailto:centergaybot@gmail.com">
<img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Gmail">
</a>
<a href="https://www.facebook.com/profile.php?id=100080498377244&mibextid=ZbWKwL">
<img src="https://img.shields.io/badge/Facebook-1877F2?style=for-the-badge&logo=facebook&logoColor=white" alt="Facebook">
</a>
<a href="https://www.youtube.com/@edwinxddd">
<img src="https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white" alt="YouTube">
</a>
<a href="https://instagram.com/edwinjvg_">
<img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white">
</a>
<a href="https://paypal.me/EdwinJV1">
<img src="https://img.shields.io/badge/PayPal-00457C?style=for-the-badge&logo=paypal&logoColor=white">
</a>
</div>

### Cuentas oficiales:
> Al acceder a la plataforma, obtendrás acceso a todos los enlaces oficiales de GayBot. Además, te mantendremos informado con boletines y mensajes exclusivos sobre las últimas novedades. La página se actualiza constantemente para ofrecerte la información más relevante. ¡No te pierdas ninguna actualización y únete a nuestra comunidad ahora mismo!

<a href="https://atom.bio/edwinjvg_">
<img src="https://img.shields.io/badge/GayBot_Accounts-000000%7D?style=for-the-badge&logo=biolink&logoColor=white">
</a>
...
|------|-------------|-------|
| **TERMUX** | ***INSTALACIÓN AUTOMÁTICA*** |[ver](https://github.com/EdwinJVG77/GayBot/#-opción-1-instalación-automática-por-termux-) |
| **TERMUX** | ***INSTALACIÓN MANUAL*** |[ver](https://github.com/EdwinJVG77/GayBot/#-opción-2-instalación-manual-por-termux---github) |
| **TERMUX** | ***INSTALACIÓN POR ARCHIVOS*** |[ver](https://github.com/EdwinJVG77/GayBot/#-opción-3-instalación-por-termux---archivos) |
| **TERMUX 24/7** | ***COMANDOS*** |[ver](https://github.com/EdwinJVG77/GayBot/#-usar-GayBot-247-en-termux) |
| **TERMUX UPDATE** | ***COMANDOS PARA ACTUALIZAR GayBot*** |[ver](https://github.com/EdwinJVG77/GayBot/#-actualizar-GayBot) |
| **HEROKU** | ***INSTALACIÓN POR HEROKU*** |[ver](https://github.com/EdwinJVG77/GayBot/#-activar-en-heroku) |
| **BOXMINE** | ***INSTALACIÓN POR BOXMINE*** |[ver](https://github.com/EdwinJVG77/GayBot#-boxminehost) |
| **REPLIT** | ***INSTALACIÓN POR REPLIT*** |[ver](https://github.com/EdwinJVG77/GayBot/#-replit---GayBot) |
| **KOYEB** | ***INSTALACIÓN POR KOYEB*** |[ver](https://github.com/EdwinJVG77/GayBot/#-activar-en-koyeb) |
| **WINDOWS** | ***INSTALACIÓN POR WINDOWS*** |[ver](https://github.com/EdwinJVG77/GayBot/#-para-usuarios-de-windowsvpsrdp) |
| **PREGUNTAS FRECUENTES** | ***DESPEJAR DUDAS*** |[ver](https://github.com/EdwinJVG77/GayBot/#-GayBot---preguntas) |
| **SOBRE GAYBOT** | ***SECCIONES DE INFORMACIÓN*** |[ver](https://github.com/EdwinJVG77/GayBot/#sobre-gaybot--gb-global) |
| **DESARROLLADORES** | ***PARTICIPATES DEL PROYECTO*** |[ver](https://github.com/EdwinJVG77/GayBot/#-creador) |
-----
...
```
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/EdwinJVG77/GayBot/master/cum.sh | bash
```
```js
...
// REFERENCIA
"wget -O - https://raw.githubusercontent.com/EdwinJVG77/GayBot/cum.sh | bash"

// PARÁMETROS QUE PUEDEN SER MODIFICADOS --> "[...]"
"wget -O - https://raw.githubusercontent.com/[usuario]/[repositorio]/[rama]/cum.sh | bash"
```
#### MODIFICAR ARCHIVO [`gay.sh`](https://github.com/EdwinJVG77/GayBot/blob/master/cum.sh)
```js
//LÍNEAS A MODIFICAR
205 --> "git clone https://github.com/[user]/[repositorio].git"
//Ejemplo: git clone https://github.com/EdwinJVG77/GayBot.git

209 --> "cd [repositorio]"
//Ejemplo: cd GayBot

//Una vez hechos estos cambios ejecute los nuevos comandos en Termux
```
-----
...
```
```bash
apt update && apt upgrade && pkg install git nodejs ffmpeg imagemagick yarn && git clone https://github.com/EdwinJVG77/GayBot && cd GayBot && yarn install && npm install && npm start
```
> **Warning** Si aparece (Y/I/N/O/D/Z) [default=N] ? use la letra "y" + "ENTER" para continuar con la instalación 
------------------
### 📁 (OPCIÓN 3) INSTALACIÓN POR TERMUX - ARCHIVOS
> **Note** Descargue y Descomprime
### [`GayBot ~ Archivos`](https://github.com/EdwinJVG77/GayBot/archive/refs/heads/master.zip)
[![blog](https://img.shields.io/badge/Termux-GayBot-FF0000?style=for-the-badge&logo=youtube&logoColor=white)
...
cd storage/downloads/GayBot/GayBot 
yarn install
npm install
npm start
```
...
> **Note** Guardar los archivos en la ubicación: storage/downloads/GayBot/GayBot   
----
### 🚀 USAR GayBot 24/7 EN TERMUX 
> Ejecutar estos comandos dentro de la carpeta GayBot
```bash
...
----
### 😼 ACTUALIZAR GayBot
> **Note** Comandos para actualizar GayBot de forma automática
```bash
grep -q 'bash\|wget' <(dpkg -l) || apt install -y bash wget && wget -O - https://raw.githubusercontent.com/EdwinJVG77/GayBot/master/update.sh | bash 
```
#### Para que no pierda su progreso en GayBot, estos comandos realizarán un respaldo de su `database.json` y se agregará a la versión más reciente.
> **Warning** Estos comandos solo funcionan para TERMUX, REPLIT, LINUX                           
----
### 🟣 ACTIVAR EN HEROKU 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/EdwinJVG77/GayBot-Heroku) 
...
### ✅ BOXMINEHOST 
[![blog](https://img.shields.io/badge/BoxMine-GayBot-FF0000?style=for-the-badge&logo=youtube&logoColor=white)
](https://youtu.be/Ko019wvu2Tc)
> Activar GayBot 24/7 en BoxMine Host
...
- [x] Resultado <details><summary>Ajustes del Servidor - GayBot</summary><img src="https://tinyurl.com/2daglygd"></details>
------------------
### ⚡ REPLIT - GayBot
[![blog](https://img.shields.io/badge/Replit-GayBot-FF0000?style=for-the-badge&logo=youtube&logoColor=white)
](https://youtu.be/pQYkq4xv37o)
<a target="_blank" href="https://replit.com/github/EdwinJVG14/GayBot"><img alt="Run on Replit" src="https://binbashbanana.github.io/deploy-buttons/buttons/remade/replit.svg"></a>
<a href="https://replit.com/github/EdwinJVG77/GayBot"> <img src="https://media0.giphy.com/media/lMwu8EJAnv9kmn51KQ/giphy.gif" height="29px"></a>
------------------
- [x] Resultado <details><summary>Importar Repositorio - GayBot</summary><img src="https://tinyurl.com/26e7usod"></details>
------------------
### 🌱 ACTIVAR EN KOYEB 

[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/EdwinJVG77/GayBot&branch=master&name=GayBot-md)

------------------
### ☁️ ACTIVAR EN RENDER 
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://dashboard.render.com/blueprint/new?repo=https%3A%2F%2Fgithub.com%2FEdwinJVG14%2FGayBot) 
...
```bash
git clone https://github.com/EdwinJVG14/GayBot && cd GayBot && npm install && npm update && node .
```
...
<summary><b>Actualizaciones y cambios</b></summary><br>
  ...
  - [x] _GayBot está en constante evolución y mejora, cada actualización busca solucionar errores, mejorar la eficiencia de las funciones existentes, agregar nuevas funciones y optimizar los recursos para una experiencia más fluida. Le recomendamos que se mantenga actualizado con las últimas versiones para disfrutar de todas las mejoras y nuevas características que se implementen en el futuro. ¡Gracias por usar GayBot!_

</details>

----
### 💠 [`IDIOMAS DISPONIBLES PARA GAYBOT`](https://github.com/EdwinJVG14/GayBot/blob/master/config.js) 
#### 🌐 Español  
#### 🌐 Inglés (English) 
#### 🌐 Portugués (Português)
...
- [x] Ejemplo <details><summary>Idioma</summary><img src="https://tinyurl.com/2awoyqtx"></details>
----

###  CREADOR 🙉
[![EdwinJVG14](https://github.com/EdwinJVG77.png?size=100)](https://github.com/EdwinJVG77) 


###  AGRADECIMIENTOS 🙉
[![GataNina-Li](https://github.com/GataNina-Li.png?size=60)](https://github.com/GataNina-Li) [![TheShadowBrokers1](https://github.com/BrunoSobrino.png?size=60)](https://github.com/BrunoSobrino)
